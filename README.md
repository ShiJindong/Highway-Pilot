...
- For Emergency: The ego vehicle should change lane left/right or brake immediately, if there are vehicles, peoples or any other obstacles ahead too close to the ego vehicle. (obstacle avoid mode)
