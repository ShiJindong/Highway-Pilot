...
double actualSpd = 0;
double routeDeviationDistance = 0;
double routeDeviationAngle = 0;
double curvatureRadius = -1;
double DistanceToTarget = 0;
double desrSpdACC = 0;
double SpdDeviationToTarget = 0;
double desrRouteDeviationDistance = 0;
int turnLeft = 0;
int turnRight = 0;
double lateralAccel = 0;
int laneChangeSteps = 1200;                                                            // Trajectory of lane change will be ended after 1200 timesteps ( = 1.2 s)
int laneChangeStepsCounter[2] = { laneChangeSteps, laneChangeSteps };                  // laneChangeStepsCounter[0]: for lane change left, laneChangeStepsCounter[1]: for lane change right
int overtakeRequest = 0;
...
User_Register (void)
{
    ...
    /* @@PLUGIN-END@@ */
    //Set_UserDesrAccelFunc(MyCalcAccel);
...
User_DeclQuants (void)
{
    ...
    DDefDouble(NULL, "Actual_Speed", "km/h", &actualSpd, DVA_None);
    DDefDouble(NULL, "Route_Deviation_Distance", "m", &routeDeviationDistance, DVA_None);
    DDefDouble(NULL, "Route_Deviation_Angle", "rad", &routeDeviationAngle, DVA_None);
    DDefDouble(NULL, "Curvature_Radius", "m", &curvatureRadius, DVA_None);
    DDefDouble(NULL, "Distance_to_Target", "m", &DistanceToTarget, DVA_None);
    DDefDouble(NULL, "desired_Speed_ACC", "km/h", &desrSpdACC, DVA_None);
    DDefDouble(NULL, "Speed_Deviation_To_Target", "km/h", &SpdDeviationToTarget, DVA_None);
    DDefInt(NULL, "Turn_Left", "", &turnLeft, DVA_DM);
    DDefInt(NULL, "Turn_Right", "", &turnRight, DVA_DM);
    DDefDouble(NULL, "lateral_Acceleration", "m/s^2", &lateralAccel, DVA_None);
    DDefDouble(NULL, "desired_Route_Deviation_Distance", "m", &desrRouteDeviationDistance, DVA_None);
    DDefInt(NULL, "Overtake_Request", "", &overtakeRequest, DVA_DM);
...
User_VehicleControl_Calc (double dt)
{
    ...
    HighwayPilotSystem myHighwayPilot(dt);
    myHighwayPilot.setDesrSpdAndLimit(130, 60, 130);
    myTest(myHighwayPilot);
